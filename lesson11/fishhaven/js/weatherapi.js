const apiURL =
  "https://api.openweathermap.org/data/2.5/weather?id=5585010&APPID=da1b0232d1ee4f20081bffe175020995&units=imperial";
fetch(apiURL)
...
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=da1b0232d1ee4f20081bffe175020995&units=imperial';
fetch(forecastURL)
  .then((response) => response.json())
  .then((forecastObject) => {
